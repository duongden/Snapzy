  ...
  var body: some View {
    Form {
      Section(L10n.PreferencesHistory.floatingPanelSection) {
        SettingRow(icon: "rectangle.stack.badge.person.crop", title: L10n.PreferencesHistory.floatingPanelTitle, description: L10n.PreferencesHistory.floatingPanelDescription) {
          Toggle("", isOn: $manager.isEnabled)
            .labelsHidden()
        }

        SettingRow(icon: "arrow.up.and.down", title: L10n.PreferencesHistory.panelPositionTitle, description: L10n.PreferencesHistory.panelPositionDescription) {
      ...
      Section(L10n.PreferencesHistory.displaySection) {
        SettingRow(icon: "line.3.horizontal.decrease.circle", title: L10n.PreferencesHistory.defaultFilterTitle, description: L10n.PreferencesHistory.defaultFilterDescription) {
      ...
      Section(L10n.PreferencesHistory.retentionSection) {
        SettingRow(icon: "clock.arrow.circlepath", title: L10n.PreferencesHistory.retentionDaysTitle, description: retentionDaysDescription) {
          HStack(spacing: 8) {
      ...
      Section(L10n.PreferencesHistory.storageSection) {
        SettingRow(icon: "trash", title: L10n.PreferencesHistory.clearHistoryTitle, description: L10n.PreferencesHistory.clearHistoryDescription) {
